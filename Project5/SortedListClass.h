#ifndef SORTEDLISTCLASS_TEMPLATE_H
#define SORTEDLISTCLASS_TEMPLATE_H
#include "LinkedNodeClass.h"

//Programmer: Yuefeng Niu
//Date: 12/8/2020
//This is the header file for SortedListClass, it specifies the functions of
//this class
...
public:
    ...
    //Copy constructor.  Will make a complete (deep)
    //copy of the list, such
    ...
    void insertValue(const T &valToInsert//The value to insert into the list
    );
